...
background-color:#5858FA;
            ...
            '''
        style2 = '<link rel="stylesheet" type="text/css" href="./foundation.css" />'
        printData = '<html><title>WikiPeopleDatabase</title>'+style2+'<body><h1 align="center">Query Results</h1><div class="row"><div class= "fifteen columns centered"><table id="wikipeople"><thead>'
        try:
        ...
        for result_object in temp:
            ...
            printData+=  '</tr>'
        printData+= '</table></div></div><h3 align="center">'+str(count)+" results fetched out of "+str(wikipeople.count())+" entries in "+str(t2)+" seconds"+'</h3>'
        printData+= '</body></html>'
        return printData
